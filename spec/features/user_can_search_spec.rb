...
describe "As a user" do
  describe 'when I visit the homepage', :vcr, js: true do
    before do
      visit '/'
    end

    context 'and I search for Paris' do
      before do
    ...
    it 'I can see reuslts from Terrabang' do
      fill_in "query", with: 'Cult'
      click_button "Search"

      expect(page).to have_content 'Terrabang'
    end
